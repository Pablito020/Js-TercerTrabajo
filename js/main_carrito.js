...
const renderProductosCarrito = () => {
    ...
    if (totalCarrito() > 0) {    
        ...
        <tbody>
        <tr>
        <td colspan="5" class="text-end"><a href="#" class="btn btncolor" onClick="vaciarCarrito()">Vaciar Carrito <img src="images/basura.png" alt="Vaciar Carrito" width="16" /></a></td>
        </tr>`;
...
//Muestro la salida del total de la suma de la tabla.
        ...
        salida = `<div class="alert alert-warning text-center" role="alert">No se encontraron Productos en el Carrito!</div>`;
    }
